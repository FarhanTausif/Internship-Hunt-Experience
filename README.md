...
- **Resume resources and my CV:** (`Sample_CV/`)
- **Detailed interview experiences:** (`Experiences/`) — converted from original PDFs
...
- **Intern Preparation Repo:** [A helpful repository for intern preparation](https://github.com/thabir303/Intern-Preparation)
